...
type
  ...
  // Test methods for class TAtualizarTotaisVenda
  ...
  // Test methods for class ABuscarClienteNome

  TestTBuscarClienteNome = class(TTestCase)
  strict private
    FBuscarClienteNome: TBuscarClienteNome;
  public
    procedure SetUp; override;
    procedure TearDown; override;
  published
...
var
  ReturnValue: Boolean;
const
  prmIdVenda: Integer = 2;
begin
  ReturnValue := FAtualizarTotaisVenda.Atualizar(prmIdVenda, true);
  CheckTrue(ReturnValue, 'Função Atualizar Totais Venda');
end;

{ TestTBuscarClienteNome }

procedure TestTBuscarClienteNome.SetUp;
begin
  FBuscarClienteNome := TBuscarClienteNome.Create();
end;

procedure TestTBuscarClienteNome.TearDown;
begin
  FBuscarClienteNome.Free();
  FBuscarClienteNome := nil;
end;

procedure TestTBuscarClienteNome.TestADD;
const
  prmNome: String = 'Marcos';
  prmCriarDM: Boolean = True;
var
  ReturnValue : Boolean;
begin
  ReturnValue := FBuscarClienteNome.Buscar(prmNome, prmCriarDM);
  CheckTrue(ReturnValue, 'Função Buscar Clientes');
end;
...
initialization
  ...
  RegisterTest(TestTAtualizarTotaisVenda.Suite);
  RegisterTest(TestTBuscarClienteNome.Suite);
